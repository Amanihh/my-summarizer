...
const Demo = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  // Check if article with trimmed URL already exists
  ...
  // Fetch summary with trimmed URL
  const { data } = await getSummary({ articleUrl: trimmedUrl });

  if (data?.summary) {
    // Create new article object with trimmed URL and summary
    const newArticle = { ...article, url: trimmedUrl, summary: data.summary };
